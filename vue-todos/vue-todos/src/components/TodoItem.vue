...
<template>
    <li>
        ...
        <div class="todo-actions">
            ...
            <Icon v-else icon="ph:pencil-fill" class="icon check-icon" color="#41b080" width="22" @click="$emit('edit-todo', index)" />
            <Icon icon="ph:trash" class="icon check-icon" color="#f95e5e" width="22" @click="$emit('delete-todo', todo.id)" />
        </div>
    </li>
</template>
